...
namespace Infrastructure.Card2CardProvider.AyandehBank
{
    public class AyandehBankCard2CardProvider : ICard2CardProvider
    {
        private readonly IOptionsMonitor<AyandehServiceConfig> _serviceConfig;
        ...
        public AyandehBankCard2CardProvider(IOptionsMonitor<AyandehServiceConfig> serviceConfig)
        {
