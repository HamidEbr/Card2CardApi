...
namespace Infrastructure.Card2CardProvider.SamanBank
{
    public class SamanBankCard2CardProvider : ICard2CardProvider
    {
        private readonly IOptionsMonitor<SamanServiceConfig> _serviceConfig;
        ...
        public SamanBankCard2CardProvider(IOptionsMonitor<SamanServiceConfig> serviceConfig)
        {
